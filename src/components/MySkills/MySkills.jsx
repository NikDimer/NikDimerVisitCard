...
import WaterCave from "./WaterCave/WaterCave";
...
import floor from "../../../src/assets/images/floor.webp";
import ceiling from "../../../src/assets/images/ceiling.svg";
...
export default function MySkills() {
    return (
        <div className={styles.MySkillsMain}>
            ...
            <div className={styles.MySkillsCave}>
                <div className={styles.MySkillsCave_Background}>
                    <Image alt="Потолок" src={ceiling} />
                    <div
                        className={styles.MySkillsCave_Background_Ceiling}
                    ></div>
                </div>
