        ...
        <div className={styles.MyPathMain}>
            ...
            <div className={styles.MyPathTrainWayContainer}>
                <div className={styles.MyPathTrainWay}>
                    ...
                    <div className={styles.MyPathTrainWayTextContainer1}><p className={styles.MyPathTrainWayText} >1.Я начал свой путь в сайтостроении при помощи HtmlAcademy, где изучил HTML, CSS, JS, немного PHP.</p></div>
                    <div className={styles.MyPathTrainWayTextContainer2}><p className={styles.MyPathTrainWayText} >2.В дальнейшем я улучшал свои навыки вёрстки и начал делать первые шаги в изучении фреймворков.</p></div>
                    <div className={styles.MyPathTrainWayTextContainer3}><p className={styles.MyPathTrainWayText} >3.Прошёл на Интенсив Яндекс Академии, где получил начальное понимание React и вектор для дальнейшего развития.</p></div>
                    <div className={styles.MyPathTrainWayTextContainer4}><p className={styles.MyPathTrainWayText} >4.С тех пор я активно занимался самообучением с помощью лекций и статей в интернете, ориентируясь по советам других опытных разработчиков.</p></div>
                </div>
            </div>
